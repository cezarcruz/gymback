...
public interface PaymentRepository extends JpaRepository<PaymentEntity, Long> {
  ...
  """)
  List<PaymentEntity> findAllByContractIdAndPaymentStatus(
      @Param("contract") Long contractId, @Param("paymentStatus") String paymentStatus);

  List<PaymentEntity> findAllByPaymentStatusAndPaymentDayLessThan(
      PaymentStatus paymentStatus, LocalDate date);
}
